...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="py-24 px-4 bg-gradient-to-b from-slate-900 to-slate-800 text-white"
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Card className="bg-slate-800/50 border-slate-700 hover:shadow-xl hover:shadow-blue-500/20 transition-all duration-300 transform hover:scale-105">
              <CardContent className="p-6 text-center">
                <div className="text-3xl font-bold text-blue-400 mb-2">10+</div>
                <div className="text-sm text-gray-400">Projects Completed</div>
              </CardContent>
            </Card>
            <Card className="bg-slate-800/50 border-slate-700 hover:shadow-xl hover:shadow-purple-500/20 transition-all duration-300 transform hover:scale-105">
              <CardContent className="p-6 text-center">
            ...
            <Card className="bg-slate-800/50 border-slate-700 hover:shadow-xl hover:shadow-teal-500/20 transition-all duration-300 transform hover:scale-105">
              <CardContent className="p-6 text-center">
                <div className="text-3xl font-bold text-teal-400 mb-2">15+</div>
                <div className="text-sm text-gray-400">Technologies</div>
              </CardContent>
            </Card>
            <Card className="bg-slate-800/50 border-slate-700 hover:shadow-xl hover:shadow-green-500/20 transition-all duration-300 transform hover:scale-105">
              <CardContent className="p-6 text-center">
          ...
          {skills.map((skill, index) => (
            ...
            >
              <CardContent className="p-6">
                <div
                  className={`w-12 h-12 rounded-lg ${skill.color} flex items-center justify-center mb-4 group-hover:shadow-lg transition-all duration-300 text-white`}
                >
                  {skill.icon}
                </div>
